...
// const Index = ({ jobs, featuredJobs, categories }) => {
...
//                             <Link href={`/jobs/${job.slug}-${job.id}`} className="hover:text-blue-600">
//                               {job.title}
//                             </Link>
//                           </h3>
//                           {job.isNew && (
...
//   const res = await fetch("http://localhost:5000/api/admin/jobs"); // replace with your backend URL
